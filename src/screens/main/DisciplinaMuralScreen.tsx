...
type NavProp = NativeStackNavigationProp<DisciplinaStackParamList, 'DisciplinaMural'>;
type RouteType = RouteProp<DisciplinaStackParamList, 'DisciplinaMural'>;
...
const posts = [
  {
    ...
    tempo: '2 horas atrás',
    conteudo:
      'Pessoal, a lista de exercícios 04 já está disponível na aba de Atividades. Prazo de entrega: domingo, 26/05, às 23:59. Qualquer dúvida, postem aqui no mural!',
    anexo: null,
    curtidas: 12,
    comentarios: 3,
    tipo: 'aviso' as const,
  },
  {
    ...
    tempo: '1 dia atrás',
    conteudo:
      'Material complementar sobre Árvores Binárias adicionado. Recomendo a leitura antes da próxima aula.',
  ...
  },
  {
    ...
    tempo: '2 dias atrás',
    conteudo:
      'Alguém conseguiu resolver o exercício 7 da lista 03? Estou travada na parte de recursão.',
    anexo: null,
    curtidas: 4,
    comentarios: 5,
  ...
  },
  {
    ...
    tempo: '3 dias atrás',
    conteudo:
      'Lembrete: a P2 será realizada no dia 05/06, das 14h às 16h, no Laboratório 3. Conteúdo: pilhas, filas e árvores.',
    anexo: null,
    curtidas: 21,
    comentarios: 7,
    tipo: 'prova' as const,
...
export default function DisciplinaMuralScreen() {
